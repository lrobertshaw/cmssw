...
process.load('L1Trigger.DemonstratorTools.CTL2JetSeedsFileWriter_cff')

process.CTL2JetSeedsFileWriter.format = cms.untracked.string(options.format)

process.MessageLogger.cerr.FwkReport.reportEvery = 1
process.Timing = cms.Service("Timing", summaryOnly = cms.untracked.bool(True))

process.p = cms.Path(process.CTL2JetSeedsFileWriter)
