...
l1tPhase1JetSumsProducer9x9trimmed = l1tPhase1JetSumsProducer.clone(
  inputJetCollectionTag = cms.InputTag("l1tPhase1JetCalibrator9x9trimmed", "l1tPhase1JetFromPfCandidates"),
)
...
l1tPhase1PuppiJetCalibrator9x9trimmed = l1tPhase1JetCalibrator9x9trimmed.clone(
    inputCollectionTag = cms.InputTag("l1tPhase1PuppiJetProducer9x9trimmed", "Uncalibratedl1tPhase1JetFromPuppiCandidates", ""),
...
l1tPhase1PuppiJetCalibrator9x9trimmedUnsorted = l1tPhase1JetCalibrator9x9trimmed.clone(
    inputCollectionTag = cms.InputTag("l1tPhase1PuppiJetProducer9x9trimmed", "Uncalibratedl1tPhase1JetFromPuppiCandidatesUnsorted", ""),
    outputCollectionName = cms.string("l1tPhase1JetFromPuppiCandidates")
)

l1tPhase1PuppiJetSumsProducer9x9trimmed = l1tPhase1JetSumsProducer.clone(
  inputJetCollectionTag = cms.InputTag("l1tPhase1PuppiJetCalibrator9x9trimmed", "l1tPhase1JetFromPuppiCandidates"),
)
