...
l1tHSCPFL1PuppiSeedProducer = l1tPhase1JetSeedProducer.clone(
    ...
    outputCollectionName = "HSCSWSEEDS",
    )
l1tHSCPFL1Puppi = l1tSeedConePFJetProducer.clone(
    useExternalSeeds = True,
    JetSeeds = ('l1tHSCPFL1PuppiSeedProducer', 'HSCSWSEEDS')
)
...
l1tHSCPFL1PuppiEmulatorSeedProducer = l1tPhase1JetSeedProducer.clone(
    inputCollectionTag = 'l1tLayer2Deregionizer:Puppi',
    outputCollectionName = "HSCHWSEEDS",
    )
l1tHSCPFL1PuppiEmulator = l1tSeedConePFJetEmulatorProducer.clone(
    useExternalSeeds = True,
    JetSeeds = ('l1tHSCPFL1PuppiEmulatorSeedProducer', 'HSCHWSEEDS'),
...
L1TPFHistoSeedJetsTask = cms.Task(
    l1tLayer2Deregionizer, l1tHSCPFL1PuppiSeedProducer, l1tHSCPFL1Puppi, l1tHSCPFL1PuppiEmulatorSeedProducer, l1tHSCPFL1PuppiEmulator, l1tHSCPFL1PuppiCorrectedEmulator
)
