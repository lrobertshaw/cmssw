...
l1t9x9Phase1JetSeedProducer3x3 = l1tPhase1JetSeedProducer.clone(
    ...
    jetIPhiSize = 9,
    trimmedGrid = False,
    outputCollectionName = "histoJetSeeds9x9_3x3",
    seedSize = 3
    )
...
l1t9x9HistoSeedsSCPFL1PuppiCorrectedEmulator3x3 = l1tSeedConePFJetEmulatorProducer.clone(
    useExternalSeeds = True,
    JetSeeds = ('l1t9x9Phase1JetSeedProducer3x3', 'histoJetSeeds9x9_3x3'),
    nJets = 16,
    L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
    doCorrections = cms.bool(False),
    correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
l1t9x9Phase1JetSeedProducer5x5 = l1tPhase1JetSeedProducer.clone(
    ...
    jetIPhiSize = 9,
    trimmedGrid = False,
    outputCollectionName = "histoJetSeeds9x9_5x5",
    seedSize = 5
    )
...
l1t9x9HistoSeedsSCPFL1PuppiCorrectedEmulator5x5 = l1tSeedConePFJetEmulatorProducer.clone(
    useExternalSeeds = True,
    JetSeeds = ('l1t9x9Phase1JetSeedProducer5x5', 'histoJetSeeds9x9_5x5'),
    nJets = 16,
    L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
    doCorrections = cms.bool(False),
    correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
l1t9x9Phase1JetSeedProducer7x7 = l1tPhase1JetSeedProducer.clone(
    ...
    jetIPhiSize = 9,
    trimmedGrid = False,
    outputCollectionName = "histoJetSeeds9x9_7x7",
    seedSize = 7
    )
...
l1t9x9HistoSeedsSCPFL1PuppiCorrectedEmulator7x7 = l1tSeedConePFJetEmulatorProducer.clone(
    useExternalSeeds = True,
    JetSeeds = ('l1t9x9Phase1JetSeedProducer7x7', 'histoJetSeeds9x9_7x7'),
    nJets = 16,
    L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
    doCorrections = cms.bool(False),
    correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
l1t9x9Phase1JetSeedProducer9x9 = l1tPhase1JetSeedProducer.clone(
    ...
    jetIPhiSize = 9,
    trimmedGrid = False,
    outputCollectionName = "histoJetSeeds9x9_9x9",
    seedSize = 9
    )
...
l1t9x9HistoSeedsSCPFL1PuppiCorrectedEmulator9x9 = l1tSeedConePFJetEmulatorProducer.clone(
    useExternalSeeds = True,
    JetSeeds = ('l1t9x9Phase1JetSeedProducer9x9', 'histoJetSeeds9x9_9x9'),
    nJets = 16,
    L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
    doCorrections = cms.bool(False),
    correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
#     useExternalSeeds = True,
#     JetSeeds = ('l1tPhase1JetSeedProducer7x7', 'histoJetSeeds7x7'),
#     nJets = 16,
#     L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
#     doCorrections = cms.bool(False),
#     correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
#     jetIPhiSize = 7,
#     trimmedGrid = False,
#     outputCollectionName = "histoJetSeeds7x7_3x3",
#     seedSize = 3
#     )
...
#     useExternalSeeds = True,
#     JetSeeds = ('l1tPhase1JetSeedProducer7x7_3x3', 'histoJetSeeds7x7_3x3'),
#     nJets = 16,
#     L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
#     doCorrections = cms.bool(False),
#     correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
#     jetIPhiSize = 7,
#     trimmedGrid = False,
#     outputCollectionName = "histoJetSeeds7x7_5x5",
#     seedSize = 5
#     )
...
#     useExternalSeeds = True,
#     JetSeeds = ('l1t7x7Phase1JetSeedProducer5x5', 'histoJetSeeds7x7_5x5'),
#     nJets = 16,
#     L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
#     doCorrections = cms.bool(False),
#     correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
#     jetIPhiSize = 7,
#     trimmedGrid = False,
#     outputCollectionName = "histoJetSeeds7x7_7x7",
#     seedSize = 7
#     )
...
#     useExternalSeeds = True,
#     JetSeeds = ('l1t7x7Phase1JetSeedProducer7x7', 'histoJetSeeds7x7_7x7'),
#     nJets = 16,
#     L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
#     doCorrections = cms.bool(False),
#     correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
...
#     jetIPhiSize = 7,
#     trimmedGrid = False,
#     outputCollectionName = "histoJetSeeds7x7_9x9",
#     seedSize = 9
#     )
...
#     useExternalSeeds = True,
#     JetSeeds = ('l1tPhase1JetSeedProducer7x7_9x9', 'histoJetSeeds7x7_9x9'),
#     nJets = 16,
#     L1PFObjects = 'l1tLayer2Deregionizer:Puppi',
#     doCorrections = cms.bool(False),
#     correctorFile = cms.string("L1Trigger/Phase2L1ParticleFlow/data/jecs/jecs_20220308.root"),
